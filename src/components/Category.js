...
const Category = () => {
  ...
  return(
  <Container>
    <Wrap onClick={()=>handleWrapClick('http://www.disney.co.kr/')}>
...
`;
/* box-shadow: 수평 수직 블러 스프레드, 
               두개넣기
   transition: 마우스올리면 변화(ex서서히 사라짐)
   opacity: 1이 다 보이는거
   ms: million second 1000분의1초
   transform: 형태바꾸기, scale은 크기 skew는 기울기... */